...
public class DriverFactory {
    ...
    public static WebDriver initDriver() {
        ...
        switch (browser) {
            ...
            case "edge":
                ...
                edgeOptions.addArguments("--no-sandbox");               //| to run in headless mode in linux servers for github actions 
    ...
    public static void quitDriver() {
        if (getDriver() != null) {
            getDriver().quit();
            tlDriver.remove(); // it stays in the computer's RAM makes memory leaks if not removed
        }
    }
}